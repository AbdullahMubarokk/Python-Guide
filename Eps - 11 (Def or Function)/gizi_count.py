...
def countNutrients(gender, age, weight, height):
    if gender == "LK":
        ...
        return print("Maaf, Gender tersebut tidak ada di dunia ini. Silakan coba dengan gender yang tersedia!")
...
def output(informations, nutrients):
    ...
    print("\nBerdasarkan Informasi yang Anda berikan, berikut adalah nutrisi yang Anda butuhkan dalam sehari : \n")
